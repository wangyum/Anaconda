...
_LEARNERCONFIG_PRUNINGMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='PRE_PRUNE', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='POST_PRUNE', index=1, number=1,
      options=None,
      type=None),
  ],
...
_LEARNERCONFIG_GROWINGMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='WHOLE_TREE', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LAYER_BY_LAYER', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_LEARNERCONFIG_MULTICLASSSTRATEGY = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='TREE_PER_CLASS', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FULL_HESSIAN', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DIAGONAL_HESSIAN', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
