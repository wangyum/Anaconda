...
# source: tensorflow/contrib/tfprof/tools/tfprof/tfprof_log.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow/contrib/tfprof/tools/tfprof/tfprof_log.proto',
  package='tensorflow.tfprof',
  syntax='proto2',
  serialized_pb=_b('\n7tensorflow/contrib/tfprof/tools/tfprof/tfprof_log.proto\x12\x11tensorflow.tfprof\"<\n\nOpLogEntry\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x11\n\tfloat_ops\x18\x02 \x01(\x03\x12\r\n\x05types\x18\x03 \x03(\t\";\n\x05OpLog\x12\x32\n\x0blog_entries\x18\x01 \x03(\x0b\x32\x1d.tensorflow.tfprof.OpLogEntry')
)
...
OpLogEntry = _reflection.GeneratedProtocolMessageType('OpLogEntry', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow.contrib.tfprof.tools.tfprof.tfprof_log_pb2'
