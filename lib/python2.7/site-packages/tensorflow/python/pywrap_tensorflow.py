...
def ReadFromStream(*args):
  return _pywrap_tensorflow.ReadFromStream(*args)
...
class Status(_object):
    ...
    if _newclass:OK = staticmethod(_pywrap_tensorflow.Status_OK)
    ...
    def Update(self, *args): return _pywrap_tensorflow.Status_Update(self, *args)
    def ToString(self): return _pywrap_tensorflow.Status_ToString(self)
...
class WritableFile(_object):
    ...
    __del__ = lambda self : None;
    def Close(self): return _pywrap_tensorflow.WritableFile_Close(self)
    def Flush(self): return _pywrap_tensorflow.WritableFile_Flush(self)
...
class BufferedInputStream(_object):
    ...
    __del__ = lambda self : None;
    def Tell(self): return _pywrap_tensorflow.BufferedInputStream_Tell(self)
    def Seek(self, *args): return _pywrap_tensorflow.BufferedInputStream_Seek(self, *args)
...
def Set_TF_Status_from_Status(*args):
  return _pywrap_tensorflow.Set_TF_Status_from_Status(*args)
...
def TryFindKernelClass(*args):
  return _pywrap_tensorflow.TryFindKernelClass(*args)
