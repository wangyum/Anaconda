...
ops.RegisterShape("GraphDefVersion")(None)
...
ops.RegisterShape("KernelLabel")(None)
_old_outputs = [""]
...
ops.RegisterShape("ResourceCreateOp")(None)
...
ops.RegisterShape("ResourceInitializedOp")(None)
...
ops.RegisterShape("StubResourceHandleOp")(None)
_test_string_output_outputs = ["output1", "output2"]


_TestStringOutputOutput = collections.namedtuple("TestStringOutput",
...
ops.RegisterShape("TestStringOutput")(None)
