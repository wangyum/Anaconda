...
_OPTIONSPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_occurrence', full_name='tensorflow.tfprof.OptionsProto.min_occurrence', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='step', full_name='tensorflow.tfprof.OptionsProto.step', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='order_by', full_name='tensorflow.tfprof.OptionsProto.order_by', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='account_type_regexes', full_name='tensorflow.tfprof.OptionsProto.account_type_regexes', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='start_name_regexes', full_name='tensorflow.tfprof.OptionsProto.start_name_regexes', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trim_name_regexes', full_name='tensorflow.tfprof.OptionsProto.trim_name_regexes', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='show_name_regexes', full_name='tensorflow.tfprof.OptionsProto.show_name_regexes', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hide_name_regexes', full_name='tensorflow.tfprof.OptionsProto.hide_name_regexes', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='account_displayed_op_only', full_name='tensorflow.tfprof.OptionsProto.account_displayed_op_only', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='select', full_name='tensorflow.tfprof.OptionsProto.select', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output', full_name='tensorflow.tfprof.OptionsProto.output', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dump_to_file', full_name='tensorflow.tfprof.OptionsProto.dump_to_file', index=16,
