...
_REMOTEFUSEDGRAPHEXECUTEINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='tensorflow.RemoteFusedGraphExecuteInfo.node', index=0,
...
_REMOTEFUSEDGRAPHEXECUTEINFO.fields_by_name['node'].message_type = tensorflow_dot_core_dot_framework_dot_node__def__pb2._NODEDEF
