...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/bin',
    'default_mod_dir':    '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/lib/python2.7/site-packages',
    'default_sip_dir':    '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/include/python2.7',
    'py_inc_dir':         '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/include/python2.7',
    'py_lib_dir':         '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/lib/python2.7/config',
    'py_version':         0x02070a,
    'qt_framework':       0,
    'sip_bin':            '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/bin/sip',
    'sip_config_args':    '',
    'sip_inc_dir':        '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/include/python2.7',
    'sip_mod_dir':        '/tmp/tmpQcQ0Zo/Anaconda-4.0.0/lib/python2.7/site-packages',
